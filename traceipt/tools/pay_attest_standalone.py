...
def build_signed_xpayment(accept, payer_key, timeout_s):
    ...
    # x402 v2 PaymentPayload as CDP validates it: {x402Version, accepted:<full
    # PaymentRequirements incl. maxTimeoutSeconds>, payload:{signature,
    # authorization}}. Echo the whole challenge requirement as `accepted`.
    envelope = {
        "x402Version": 2,
        "accepted": accept,
