...
# Service-category classifier lives in its own stdlib-only module so any consumer
# (here, or Traceipt tagging a receipt) can reuse it without importing this whole
# module. DESCRIPTIVE ONLY -- never gates a verdict. See docs/CATEGORY.md.
from categories import (  # noqa: F401  (re-exported for callers/tests)
    CATEGORY_RULES, CATEGORY_UNCLASSIFIED, classify_category, classify_resource)
